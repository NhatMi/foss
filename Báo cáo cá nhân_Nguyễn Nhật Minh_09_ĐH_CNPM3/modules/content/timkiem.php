<?php 
		$conn = mysqli_connect("localhost","root","","shoppingcart") or die("Kết nối thất bại");
...
<div id="maincontent" class="col-xs-12 col-sm-8 col-md-12" >
				<div  class="text-left">
                    <form action="index.php" method="get">
                        ...
                        <input type="text" class="tim" name="key" value="<?php echo $keyword; ?>" placeholder="Nhập sản phẩm" id="tennc">
                        <span>GIÁ: </span>
                        <input type="text" name="giatu" placeholder="Giá từ" class="tim" id="giatu" value="<?php echo $giamin ?>" onkeyup="kiemtraso()">
                        <input type="text" name="giaden" placeholder="Giá đến" class="tim" id="giaden" value="<?php echo $giamax ?>" onkeyup="kiemtrasoden()">
                        <span>LOẠI: </span><select name="idL" class="tim" id="loai">
